class plane:
    ...
    def __init__(self, name: str, flight_number : int, power : int, purchased_seats : int):
        self.Name = name
    ...
    def get_routes(self):
        routes = {1: "Paris-Moscow", 2: "Moscow-Paris", 3: "Moscow-Seoul", 4: "Seoul-Moscow"}
...
print("Прибыль с продажи белетов составляет:",Plane.revenue_calculation(23000), "рублей")
